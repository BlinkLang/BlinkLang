...
class Resolver implements Expr.Visitor<Void>, Stmt.Visitor<Void> {
    ...
    public Void visitClassStmt(Stmt.Class stmt) {
        ...
        if (stmt.superclass != null && stmt.name.lexeme.equals(stmt.superclass.name.lexeme)) {
            Blink.error(stmt.superclass.name, "A class cannot inherit itself.");
        }
    ...
    public Void visitSuperExpr(Expr.Super expr) {
        if (currentClass == ClassType.NONE) {
            Blink.error(expr.keyword, "Cannot use 'super' outside of a class.");
        } else if (currentClass != ClassType.SUBCLASS) {
            Blink.error(expr.keyword, "Cannot use 'super' in a class without a superclass.");
        }
    ...
    private void declare(Token name) {
        ...
        if (scope.containsKey(name.lexeme)) {
            Blink.error(name, "A variable with this name has already been declared in this scope.");
        }
